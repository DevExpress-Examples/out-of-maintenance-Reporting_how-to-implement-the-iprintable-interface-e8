...
Namespace IPrintableImplementation
	Partial Public Class Form1
		...
		Private Sub btnPrintPreview_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnPrintPreview.Click
			If Not Me.btnPrintPreview.IsHandleCreated Then Return
		...
		Private Function CreatePrintableListView() As PrintableListView
			...
			Dim listViewItem1 As New ListViewItem(New ListViewItem.ListViewSubItem() {
			...
			Dim listViewItem2 As New ListViewItem(New ListViewItem.ListViewSubItem() {
			...
			Dim listViewItem3 As New ListViewItem(New ListViewItem.ListViewSubItem() {
			...
			Dim listViewItem4 As New ListViewItem(New ListViewItem.ListViewSubItem() {
			...
			Dim listViewItem5 As New ListViewItem(New ListViewItem.ListViewSubItem() {
