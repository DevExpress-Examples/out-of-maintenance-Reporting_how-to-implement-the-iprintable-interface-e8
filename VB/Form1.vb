...
Namespace IPrintableImplementation
	Partial Public Class Form1
		...
		Private Function CreatePrintableListView() As PrintableListView
			...
			Dim listViewItem1 As New ListViewItem(New ListViewItem.ListViewSubItem() { New ListViewItem.ListViewSubItem(Nothing, "Belgium", SystemColors.WindowText, SystemColors.Window, New Font("Microsoft Sans Serif", 8.25F, FontStyle.Regular, GraphicsUnit.Point, (CByte(1)))), New ListViewItem.ListViewSubItem(Nothing, "Belgian Franc"), New ListViewItem.ListViewSubItem(Nothing, "Brussels")}, 0)
			Dim listViewItem2 As New ListViewItem(New ListViewItem.ListViewSubItem() { New ListViewItem.ListViewSubItem(Nothing, "Brazil", SystemColors.WindowText, SystemColors.Window, New Font("Microsoft Sans Serif", 8.25F, FontStyle.Regular, GraphicsUnit.Point, (CByte(1)))), New ListViewItem.ListViewSubItem(Nothing, "Real"), New ListViewItem.ListViewSubItem(Nothing, "Brasilia")}, 1)
			Dim listViewItem3 As New ListViewItem(New ListViewItem.ListViewSubItem() { New ListViewItem.ListViewSubItem(Nothing, "Canada", SystemColors.WindowText, SystemColors.Window, New Font("Microsoft Sans Serif", 8.25F, FontStyle.Regular, GraphicsUnit.Point, (CByte(1)))), New ListViewItem.ListViewSubItem(Nothing, "Canadian Dollar"), New ListViewItem.ListViewSubItem(Nothing, "Ottawa")}, 2)
			Dim listViewItem4 As New ListViewItem(New ListViewItem.ListViewSubItem() { New ListViewItem.ListViewSubItem(Nothing, "Denmark", SystemColors.WindowText, SystemColors.Window, New Font("Microsoft Sans Serif", 8.25F, FontStyle.Regular, GraphicsUnit.Point, (CByte(1)))), New ListViewItem.ListViewSubItem(Nothing, "Krone"), New ListViewItem.ListViewSubItem(Nothing, "Copenhagen")}, 3)
			Dim listViewItem5 As New ListViewItem(New ListViewItem.ListViewSubItem() { New ListViewItem.ListViewSubItem(Nothing, "Finland", SystemColors.WindowText, SystemColors.Window, New Font("Microsoft Sans Serif", 8.25F, FontStyle.Regular, GraphicsUnit.Point, (CByte(1)))), New ListViewItem.ListViewSubItem(Nothing, "Markka"), New ListViewItem.ListViewSubItem(Nothing, "Helsinki")}, 4)
