...
'INSTANT VB NOTE: The variable bounds was renamed since Visual Basic does not handle local variables named the same as class members well:
				Dim bounds_Renamed As Rectangle = Items(0).Bounds
				pt = bounds_Renamed.Location
				pt.Y -= 3
			End If
...
'INSTANT VB NOTE: The variable size was renamed since Visual Basic does not handle local variables named the same as class members well:
			Dim size_Renamed As SizeF = graphics.MeasureString(text, Font)
			size_Renamed.Width += 2 ' Border size
			size_Renamed.Height += 2 ' Border size
			graphics.Dispose()
			Return size_Renamed
		End Function
...
'INSTANT VB NOTE: The variable font was renamed since Visual Basic does not handle local variables named the same as class members well:
			Dim font_Renamed As New Font("Arial", 9)
			graph.DefaultBrickStyle = New BrickStyle(BorderSide.None, 1, Color.Black, Color.Transparent, Color.Black, font_Renamed, New BrickStringFormat(StringAlignment.Center, StringAlignment.Center))
...
'INSTANT VB NOTE: The variable height was renamed since Visual Basic does not handle local variables named the same as class members well:
			Dim height_Renamed As Single = font_Renamed.Height + 2

			Dim r As New RectangleF(0, 0, 0, height_Renamed)
